...
sudo git clone -b docker_branch_v1 https://github.com/GoPlugin/pluginDeploymentApothem.git && cd pluginDeploymentApothem/
sudo git clone https://github.com/nmzn/pluginnode-docker.git && cd pluginnode-docker && sudo cp docker-compose.yaml /opt/docker/goplugin/pluginDeploymentApothem && cd ..
